...
const Step5Review = () => {
  ...
  return (
    <StepSection title="These links will be visible in your profile section on the website">
      <Grid container spacing={3}>
            ...
            <AccordionDetails sx={{ px: 2, pb: 3 }}>
              ...
              <Box sx={{ mb: 2 }}>
                ...
                <TextField
                  ...
                  sx={inputStyle}
                  error={!!errors.medium}
                  helperText={errors.medium?.message as string}
                />
              </Box>
        ...
        <Grid item xs={12}>
          ...
          <FormHelperText sx={{ mt: 0.5 }}>
            We ask for your pronouns to ensure we address you correctly and
            respectfully.
          </FormHelperText>
          {errors.pronouns && (
        ...
        <Grid item xs={12}>
          <FormControl error={!!errors.socialHighlight}>
            <Typography variant="subtitle2" sx={boldLabelStyle}>
              Are you happy for us to highlight/promote you as our mentor on our
              social media?{' '}
              <Box component="span" sx={{ color: 'error.main' }}>
                *
              </Box>
            ...
            />
            <FormHelperText>
              Please make sure your details are always up to date on our
              website.
            </FormHelperText>
            {errors.socialHighlight && (
              <FormHelperText error>
                {errors.socialHighlight.message as string}
              </FormHelperText>
            )}
          </FormControl>
        </Grid>
        ...
        <Grid item xs={12} sx={{ mt: 2 }}>
          ...
          <Box
            component="ul"
            sx={{ pl: 2, mb: 2, typography: 'body2', color: 'text.primary' }}
          >
            ...
            <li>
              ...
              above-mentioned contact details to contact me and include my
              mentor profile on our website.
            </li>
          </Box>
