    ...
    >
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12}>
          ...
          <FormGroup>
            <FormControlLabel
              control={<Checkbox {...register('isLongTermMentor')} />}
              label="Long-Term Format"
            />
            ...
            <FormControlLabel
              control={<Checkbox {...register('isAdHocMentor')} />}
              label="Ad-Hoc Format"
            />
            ...
            {isAdHoc && (
              ...
              >
                ...
                >
                  For each month below, please indicate the maximum number of
                  mentees you are available to support.{' '}
                      ...
                      {months.map((month) => (
                        <TableRow key={month}>
                          <TableCell
                            component="th"
                            scope="row"
                            sx={{ pl: 0, fontWeight: 400, fontSize: '16px' }}
                          >
                            {month}
                          </TableCell>
          ...
          {errors.isLongTermMentor && (
            <FormHelperText error sx={{ mt: 1 }}>
              Please select at least one mentorship format.
            </FormHelperText>
          )}
        </Grid>
        ...
        <Grid item xs={12}>
          ...
          <TextField
            ...
            helperText={errors.calendlyLink?.message as string}
          />
        </Grid>
        ...
        <Grid item xs={12}>
          <Typography
            ...
            sx={{ mb: 0.5, color: 'text.primary' }}
          >
            What kind of Mentee are you looking for? *
          </Typography>
          <TextField
            fullWidth
            multiline
            ...
            helperText={errors.menteeExpectations?.message as string}
          />
        </Grid>
