...
test('should display complete navigation menu', async ({ page, landingPage }) => {
  await page.goto('/');
...
test.describe('Navigation Links', () => {
  navTests.forEach(({ id, linkName: linkName, pathToStart, linkLocator: linkLocator, expectedURL, expectedText }) => {
    test(`${id}: Test "${linkName}" Link Navigation`, async ({ page, landingPage }) => {
