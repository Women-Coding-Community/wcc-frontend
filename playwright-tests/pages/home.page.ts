...
export class HomePage extends BasePage {
  ...
  readonly joinSlackButton: Locator;
    ...
    this.mainHeading = page
      .getByRole('heading', { name: 'Opportunities and Programmes' });
    this.mainText = page.getByRole('heading', { name: 'Join our community and unlock' })
    this.mentorshipLink = page.getByRole('link', { name: 'Mentorship' })
    this.eventsLink = page.getByRole('link', { name: 'Online and in-person Events' })
    this.bookClubLink = page.getByRole('link', { name: 'Book Club' });
    this.CvClinicLink = page.getByRole('link', { name: 'CV clinic' });
    this.mockInterviewsLink= page.getByRole('link', { name: 'Mock interviews' });
